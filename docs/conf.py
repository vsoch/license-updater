...
# -*- coding: utf-8 -*-
#
# license-updater documentation build configuration file, created by
...
from license_updater import version  # noqa
...
htmlhelp_basename = "license-updater-doc"
...
latex_documents = [
    ("index", "license-updater.tex", "license-updater Documentation", "Vanessa Sochat", "manual"),
]
...
texinfo_documents = [
    (
        "index",
        "license-updater",
        "license-updater Documentation",
        ["Vanessa Sochat"],
        "license-updater",
        "license-updater is a tool for updating GitHub action workflows",
        "Miscellaneous",
    ),
]
